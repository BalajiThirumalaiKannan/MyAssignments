...
var UserAuthenticator = /** @class */ (function () {
    ...
    UserAuthenticator.prototype.login = function (userName, passWord, buttonClick) {
        console.log("Username:".concat(userName, " and Password:").concat(passWord));
    };
    UserAuthenticator.prototype.logout = function () {
        console.log("User is looged out");
    };
    UserAuthenticator.prototype.paswwordReset = function () {
